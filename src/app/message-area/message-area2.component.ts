...
export class MessageAreaMessage2{
    public messageType : string;
    public message: string;
}

@Component({
    selector: 'ng2-message2-area',
    template: `
<style>
    .closeMargin {
    margin-top: -9px;
...
<div class="{{message.messageType}}" style="height: 33px;    margin-top: -14.5px;
    margin-left: -14px;
    margin-right: -15px;">
...
export class MessageAreaComponent2 implements OnInit {

    private messages: Array<MessageAreaMessage2>;
    ...
    ngOnInit(): any {
        this.service.observable.subscribe((event:MessageAreaMessageEvent) => {
            ...
            let message  = new MessageAreaMessage2();
